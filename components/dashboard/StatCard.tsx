...
export default function StatCard({ label, value, sub, icon, href, trend, color }: StatCardProps) {
  ...
  return (
    <Link
      href={href}
      className="group block bg-white/80 backdrop-blur-sm border border-gray-100 rounded-2xl p-5 shadow-md transition-all duration-300 hover:shadow-xl hover:-translate-y-1 active:scale-[0.98]"
    >
