  ...
  return (
    <Link
      ...
      className={cn(
        ...
        // Interactions
        "hover:-translate-y-1 hover:shadow-lg active:scale-95 active:bg-indigo-50 focus-visible:ring-2 focus-visible:ring-indigo-400 transition-all duration-200"
      )}
    >
